                            ...
                            <div class="card-body">
                                <div class="row">
                                	...
                                	<h4 class="col-2 card-title" style="text-align: right;">
                                		<a class="btn btn-info" href="../public/localidad_pais_m.php?mode=C&codigo=0" role="button" title="Agregar"><i class="ti-plus"></i></a>
                                	</h4>
								</div>
...
?>
    ...
    <script src="../js/localidad_pais.js"></script>
</body>
</html>