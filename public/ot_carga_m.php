        ...
        $(document).ready(function() {
            ...
            $('#addRow').on( 'click', function () {
                tabDat.row.add( [
                    ...
                    "<td><input  id='poblacionCantidad"+ colCod +"' name='poblacionCantidad"+ colCod +"' class='form-control' type='number' onchange='sumaTotal()' min='1' required></td>"
                ] ).draw( true );
                colCod++;
            } );
