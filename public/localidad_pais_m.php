<?php
	...
	if ($workCodigo <> 0){
		...
		if ($dataJSON['code'] == 200){
			$row_01			= $dataJSON['data'][0]['estado_pais_codigo'];
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a href="../public/localidad_pais_l.php">Localidad Pa&iacute;s</a>
                                    </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form" data-parsley-validate class="m-t-30" method="post" action="../class/crud/localidad_pais_a.php">
                                    ...
                                    <div class="form-group">
                                    	<label for="paisObservacion">Observaci&oacute;n</label>
                                    	<textarea id="paisObservacion" name="paisObservacion" class="form-control" rows="5" <?php echo $workReadonly; ?>><?php echo $row_04; ?></textarea>
                                	</div>
                                    <button type="submit" class="btn <?php echo $workAStyle; ?>" <?php echo $workReadonly; ?>><?php echo $workATitulo; ?></button>
                                    <a role="button" class="btn btn-dark" href="../public/localidad_pais_l.php">Volver</a>
                                </form>
                            </div>
                        </div>
                    </div>
