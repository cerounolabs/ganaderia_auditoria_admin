$(document).ready(function() {
	...
	$('#tableLoad').DataTable({
		...
		columns		: [
			...
			{ render			: function (data, type, full, meta) {return '<a href="../public/establecimiento_m.php?mode=R&codigo=' + full.establecimiento_codigo + '" role="button" class="btn btn-primary"><i class="ti-eye"></i>&nbsp;</a>&nbsp;<a href="../public/establecimiento_m.php?mode=U&codigo=' + full.establecimiento_codigo + '" role="button" class="btn btn-success"><i class="ti-pencil"></i>&nbsp;</a></a>&nbsp;<a href="../public/establecimiento_m.php?mode=D&codigo=' + full.establecimiento_codigo + '" role="button" class="btn btn-danger"><i class="ti-trash"></i>&nbsp;</a>';}},
		]
	});
});